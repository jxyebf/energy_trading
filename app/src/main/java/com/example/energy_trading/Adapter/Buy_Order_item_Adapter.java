...
public class Buy_Order_item_Adapter extends BaseAdapter {
    private Context context;
    private ArrayList<Order_item> orderitemlistData;

    public Buy_Order_item_Adapter(Context context, ArrayList<Order_item> orderitemlistData) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewholder.style_of_order_username.setText("Seller: ");
        viewholder.order_username11111.setText(order_item.getSeller_username());
