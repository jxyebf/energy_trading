...
public class Buy_Order_Detail_Fragment extends FragmentActivity {
    ...
    private String order_status_1="Order Completed";
    private String order_id,order_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTransactionCompleted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //modify_status();
                AlertDialog_Modify();
    ...
    private void AlertDialog_Modify(){
        ...
        dialog.setTitle("Sure to modify the order status to completed?");
    ...
    private void modify_status(){
        ...
        try {
            jsonObject.put("order_status", order_status_1);
        ...
        Request request = new Request.Builder()
                .url("http://192.168.138.48/energy_trade/modify_status.php")
                .post(requestBody)
                .build();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //客户端自己判断是否成功。
                        if (retCode == 1) {
                            Toast.makeText(Buy_Order_Detail_Fragment.this,"Order status modified successfully!",Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(Buy_Order_Detail_Fragment.this,"Order status modification failure!",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //客户端自己判断是否成功。
                        if (retCode == 1) {
                            Toast.makeText(Buy_Order_Detail_Fragment.this,"Order deleted successfully!",Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(Buy_Order_Detail_Fragment.this,"Order deletion failure!",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void initView(){
        ...
        String order_seller_name=bundle.getString("order_seller_name");
        ...
        if(order_status.equals(order_status_1)){
            Log.i(TAG, "2222222222222222222222222222222222222222222: " + order_status );
            btnTransactionCompleted=this.findViewById(R.id.btn_transaction_completed);
